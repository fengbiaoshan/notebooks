...
class WindowModel(NERModel):
    ...
    def add_embedding(self):
        ...
        """
        ### YOUR CODE HERE (!3-5 lines)
        embeddings_table = tf.Variable(self.pretrained_embeddings, tf.float32)                                                     
    ...
    def add_prediction_op(self):
        ...
        b1 = tf.get_variable("b1", shape=[self.config.hidden_size], initializer=tf.constant_initializer())
